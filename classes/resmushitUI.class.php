...
Class reSmushitUI {
	...
	public static function settingsPanel() {
        ...
        . self::addSetting("checkbox", __("Generate WebP", 'resmushit-image-optimizer'), sprintf(__("Create WebP versions of the images.", 'resmushit-image-optimizer')), "resmushit_enable_webp")
